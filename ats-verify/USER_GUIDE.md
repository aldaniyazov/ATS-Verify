...
- **Авторизация пользователей:** Пользователи, зарегистрировавшиеся в системе (за исключением корпоративных адресов `@ats-mediafon.kz`, `monzya@inbox.ru` и `lauka81@mail.ru`), по умолчанию ожидают вашего подтверждения. Перейдите в раздел управления пользователями, чтобы рассмотреть и одобрить (`Approve`) их заявки.
...
*Примечание: Доступ автоматически выдается только авторизованным электронным адресам (monzya@inbox.ru и lauka81@mail.ru).*
...
*Примечание: Пользователи с почтой `@ats-mediafon.kz` получают эту роль автоматически после регистрации.*
